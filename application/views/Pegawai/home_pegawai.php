...
<section id="main">
  <div class="container">
    <div class="row">
      ...
      <?php foreach ($jumlah as $key) { ?>
      <a href="<?php echo site_url()?>/pegawai/halamanPasien" class="list-group-item"><span class="glyphicon glyphicon-user" aria-hidden="true"></span> Data Pasien<span class="badge"><?php echo $key->jumlah?></span></a>
      <?php } ?>
